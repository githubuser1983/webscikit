#!/usr/bin/python
"""
This is an example python script to fit the model boston.
Please do not import locally anything other than BostonModel from boston_model,
otherwise pickling will not work and you can not deploy the model.
"""
import sys, datetime
sys.path.insert(1,"/usr/local/lib/python2.7/dist-packages/")
from boston_model import BostonModel
